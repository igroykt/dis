...
Перед сбором информации проверяется доступность компьютера. Если компьютер не доступен, то в консоль выдается соответствующее сообщение и генерируется html файл с указанием возможных причин не доступности компьютера.  
